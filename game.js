...
function preload() {
    // Load Background
    this.load.image('bg', 'free-cyberpunk-overlay-effects-for-platformer-game/1-30.png');

    // Load Biker Sprites
    this.load.spritesheet('biker_run', 'Free 3 Cyberpunk Sprites Pixel Art/1 Biker/Biker_run.png', { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet('biker_jump', 'Free 3 Cyberpunk Sprites Pixel Art/1 Biker/Biker_jump.png', { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet('biker_doublejump', 'Free 3 Cyberpunk Sprites Pixel Art/1 Biker/Biker_doublejump.png', { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet('biker_idle', 'Free 3 Cyberpunk Sprites Pixel Art/1 Biker/Biker_idle.png', { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet('biker_attack', 'Free 3 Cyberpunk Sprites Pixel Art/1 Biker/Biker_run_attack.png', { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet('biker_punch', 'Free 3 Cyberpunk Sprites Pixel Art/1 Biker/Biker_punch.png', { frameWidth: 48, frameHeight: 48 });
    this.load.spritesheet('biker_kick', 'Free 3 Cyberpunk Sprites Pixel Art/1 Biker/Biker_attack3.png', { frameWidth: 48, frameHeight: 48 });
    
    // Load Cyborg (Enemy)
    this.load.spritesheet('cyborg_run', 'Free 3 Cyberpunk Sprites Pixel Art/3 Cyborg/Cyborg_run.png', { frameWidth: 48, frameHeight: 48 });

    // Load Punk (Flying Enemy)
    this.load.spritesheet('punk_doublejump', 'Free 3 Cyberpunk Sprites Pixel Art/2 Punk/Punk_doublejump.png', { frameWidth: 48, frameHeight: 48 });

    // Load Sounds (Switched to cleaner beeps/clicks)
    this.load.audio('jump', 'zapsplat_pack_cyberpunk_computer_sounds_mp3/zapsplat_science_fiction_cyberpunk_electronics_beep_002_61683.mp3');
    this.load.audio('attack', 'zapsplat_pack_cyberpunk_computer_sounds_mp3/zapsplat_science_fiction_cyberpunk_computer_equipment_or_machine_clicks_61358.mp3');
    this.load.audio('kill', 'zapsplat_pack_cyberpunk_computer_sounds_mp3/zapsplat_science_fiction_cyberpunk_electronics_beep_003_61684.mp3');
    this.load.audio('gameover', 'zapsplat_pack_cyberpunk_computer_sounds_mp3/zapsplat_science_fiction_cyberpunk_electronics_beep_001_61682.mp3');
}
